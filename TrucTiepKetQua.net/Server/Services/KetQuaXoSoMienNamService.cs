...
public class KetQuaXoSoMienNamService : IHostedService, IDisposable
{
    private readonly ILogger<KetQuaXoSoMienNamService> _logger;
    private Timer _timer = null!;
    private DateTime _date;
    private string _url = @"https://xoso.me/xsmn-{0}-ket-qua-xo-so-mien-nam-ngay-{0}.html";
    private IMongoCollection<KqxsMnModel> _mongoCollection;
    private DateTime _timeStart = new DateTime(2022, 01, 01, 16, 10, 0);
    private DateTime _timeStop = new DateTime(2022, 01, 01, 16, 50, 0);
